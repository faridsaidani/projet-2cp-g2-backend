...
const NextAppointment = ({photo , timing, name, age ,topics }) => {
  return (
    <div className='flex flex-col flex-start justify-between items-center h-[100%] w-[100%] border rounded-xl p-4 shadow-xl'>
        ...
        <div className='flex flex-start flex-col border-b-[1px] pb-2'>
          <p className='font-urbanist text-sm font-semibold leading-3 text-left text-primdark'>Topics:</p>
          <p className='font-urbanist text-sm font-semibold leading-4 text-left text-secdark my-2'>{topics}</p>
        </div> 
