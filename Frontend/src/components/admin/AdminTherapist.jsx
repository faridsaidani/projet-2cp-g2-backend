  ...
  const MySidebarlist = Sidebarlist.map((side) => {
    return (
      ...
      >
        ...
        <li>
          <button className=" text-[12px] font-[700] leading-[14.4px] w-[69px]  border border-[#4C606E] items-center h-[40px] font-urbanist text-primary1 rounded-[10px]  ">
            {side.v}
          </button>
        </li>
        <li className=" text-[14px] font-semibold leading-[16.8px] font-urbanist text-[#202224]">
        ...
        <li className="flex w-[20%] justify-between items-center">
          {" "}
          <button className="text-[#00B69B] text-[12px] font-[700] leading-[14.4px]   w-[95px] rounded-lg h-[33px] font-urbanist bg-[#c6f6ef] ">
            {side.ap}
          </button>
          ...
          <div className="shadow-multiple border border-white rounded-[22px] ">
            <div className="py-[15px] px-[60px] border border-b-0 rounded-tl-[22px] rounded-tr-[22px] border-[#D5D5D5] ">
              <ul className="flex justify-between ">
                <li className=" text-[14px] font-extrabold leading-[16.8px] font-urbanist text-[#202224]">
                  Name
                </li>
                <li className=" text-[14px] font-extrabold leading-[16.8px] font-urbanist text-[#202224]">
                  Email
