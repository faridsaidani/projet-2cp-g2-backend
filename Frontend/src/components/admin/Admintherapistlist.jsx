...
const Admintherapistlist = () => {
  const Sidebarlist = [
    {
      ...
      title: "Therapist",
      name: "Jason Price",
      src: "https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/b7ct4o7yp7-127%3A1180?alt=media&token=b580fd5a-c5ca-437f-b9ea-024796297bd5",
    },
    {
      id: 2,
      email: "janick_parisian@yahoo.com",
  ...
  return (
    <div className=" w-[98%] mt-6">
      <p className=" mb-[32px]  text-[#063248] text-[32px] leading-8  font-urbanist  font-[700]  tracking-[-0.1px]">
        My Therapists
      </p>

      <ul className="grid grid-cols-4 gap-4 w-full">{MySidebarlist}</ul>
    </div>
  );
};
