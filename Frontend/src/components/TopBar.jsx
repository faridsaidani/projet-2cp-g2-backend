...
const TopBar = () => {
    ...
    return (
        <div className="flex justify-between items-center bg-primback rounded-3xl py-4 px-8 mt-10 mr-10">
            
            {/* Search Bar */}
            <div className=" flex items-center relative w-[70%] border border-secdark rounded-3xl py-2">
                ...
                <input
                    ...
                    className="w-[93%] pl-2 rounded-md  bg-primback text-secdark placeholder-secdark focus:outline-none font-Urbanist text-sm font-base leading-[19.2px] text-left"
