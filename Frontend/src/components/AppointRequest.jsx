...
const AppointRequest = () => {
    ...
    const Sidebarlist = [
        { id: 1, name:"Bellatreche HIba", date:"07 July,",hour:"9:15 - 11:00 AM",statu:"Re-Consultation", age:"32 y.o" , lang:"English",gender:"Female", case:"Solitude" ,Approv:"Confirm"},
        { id: 2, name:"Bellatreche HIba", date:"07 July,",hour:"9:15 - 11:00 AM",statu:"Re-Consultation", age:"32 y.o" , lang:"English",gender:"Female", case:"Solitude" ,Approv:"Confirm"},
        { id: 3, name:"Bellatreche HIba",date:"07 July,",hour:"9:15 - 11:00 AM", statu:"Re-Consultation", age:"3.2" , lang:"English",gender:"Female", case:"Solitude" ,Approv:"Confirm"},
        { id: 4, name:"Bellatreche HIba", date:"07 July,",hour:"9:15 - 11:00 AM",statu:"Re-Consultation", age:"3.2" , lang:"English",gender:"Female", case:"Solitude" ,Approv:"Confirm"},
...
<p className=' text-[14px]  font-semibold  leading-[16.8px] font-urbanist text-primary1'>
    ...
    <li className=' text-[14px] font-semibold leading-[16.8px] font-urbanist text-[#4C606E]'>
       <p className='text-[14px] font-semibold leading-[16.8px] font-urbanist text-[#4C606E] '> {side.date}</p>
       <p className='text-[12px] font-semibold leading-[12px] font-urbanist text-[#b5bec580] '>{side.hour}</p>
        </li>
...
<path d="M9 17C13.1422 17 16.5 13.6422 16.5 9.5C16.5 5.35775 13.1422 2 9 2C4.85775 2 1.5 5.35775 1.5 9.5C1.5 13.6422 4.85775 17 9 17Z" stroke="#298EA6" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M6.75 9.5L8.25 11L11.25 8" stroke="#298EA6" stroke-linecap="round" stroke-linejoin="round"/>
</svg>


      {side.Approv}</button>
      <button className='w-[33px] items-center justify-center border-[0.6px] border-[#EF3826] rounded-lg h-[33px]'><svg className='mx-auto ' width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M9 17C13.1421 17 16.5 13.6421 16.5 9.5C16.5 5.35786 13.1421 2 9 2C4.85786 2 1.5 5.35786 1.5 9.5C1.5 13.6421 4.85786 17 9 17Z" stroke="#EF3826" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M11.25 7.25L6.75 11.75" stroke="#EF3826" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M6.75 7.25L11.25 11.75" stroke="#EF3826" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</button></li>
  ...
  return (
    <div className='top-[116px]'>
      ...
      <p className='text-[#4C606E] mb-[32px] text-[14px] leading-[16.8px]  font-urbanist  font-[600] '>Check and Approve your new appointements </p>
...
<div className=' rounded-tl-[22px] rounded-tr-[22px] border-[#D5D5D5] '>
    <p className= ' py-[15px] px-[23px] text-primary1 text-[20px] font-bold leading-[24px] font-urbanist'> Appointement Requests  <span className='text-[16px] font-semibold leading-[19.2px] font-urbanist text-[#4C606E]'>(4 new Requests)</span></p>
  <ul className='flex py-[15px] pl-[23px] pr-[300px] border-[0.6px] w-[100%] border-[#D5D5D5]  justify-between '>
    ...
    <div className=' text-[14px] font-extrabold leading-[16.8px] font-urbanist text-[#063248]'>date</div>
    <div className='flex justify-between'>
    <div className=' text-[14px] font-extrabold leading-[16.8px] font-urbanist text-[#063248]'>Age</div>
    ...
    <li className=' text-[14px] font-extrabold leading-[16.8px] font-urbanist text-[#063248]'>Approval</li>
