...
function Quiz() {
  ...
  return (
    <div className='flex items-center bg-primback w-[100%] h-[100%] p-10 rounded-3xl'>

        {/*Previous*/}
        <button
          disabled={currentQuestionIndex === 0}
          onClick={handlePreviousQuestion}
          className="bg-sechover text-secwhite py-2 px-4 rounded-full mr-auto"
        >
          &#8592;
        </button>
        ...
        {/* Next */}
        <button
          disabled={currentQuestionIndex === questionsByConcern[concern].length - 1}
          onClick={handleNextQuestion}
          className="bg-sechover text-secwhite py-2 px-4 rounded-full ml-auto"
        >
          &#8594;{/*Next*/}
        </button>
