 ...
 "
      >
        <div className=" flex flex-col justify-start items-center gap-5 w-[undefinedundefined] box-border">
          <div className=" flex flex-col justify-between items-center  gap-[18px] w-[100%] h-[100%] box-border">
            ...
            >
              ...
              />
              <path
                d="M31.5 24V16C31.5 15.4696 31.2893 14.9609 30.9142 14.5858C30.5391 14.2107 30.0304 14 29.5 14H15.5C14.9696 14 14.4609 14.2107 14.0858 14.5858C13.7107 14.9609 13.5 15.4696 13.5 16V30C13.5 30.5304 13.7107 31.0391 14.0858 31.4142C14.4609 31.7893 14.9696 32 15.5 32H23.5"
                stroke="#298EA6"
                strokeWidth="1.5"
                strokeLinecap="round"
        ...
        <div className=" text-[#4C606E] flex flex-col justify-center items-center gap-3 w-[100%] box-border">
          ...
          <p className=" flex flex-col justify-center  text-[#4C606E] border-[#4c606eff] text-base leading-4  font-urbanist  font-[500] text-center">
            Your appointement will be confiremed shortly and we will notify
            through mail.
          </p>
        </div>
        <div className=" flex flex-row justify-start items-start gap-3 w-[undefinedundefined] box-border">
          <button
            onClick={onClose}
            className=" text-[#298ea6ff] flex flex-row justify-center items-center gap-2.5 h-[100%] px-[66px] py-[13px] border-[0.5px]  border-[#298ea6ff] border-solid rounded-lg box-border"
          >
            Cancel
          </button>
          <Link to="/patient/">
