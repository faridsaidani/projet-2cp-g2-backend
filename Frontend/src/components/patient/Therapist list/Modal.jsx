...
const Modal = ({ open, onClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    newForm.append("name", appointmentSubject);
    // newForm.append("appointmentDescription", appointmentDescription);
    newForm.append("date", appointmentDate);
    newForm.append("time", appointmentTime);
    newForm.append("therapist_id", localStorage.getItem("therapist_id"));
    newForm.append("patient_id", localStorage.getItem("user_id"));
    console.log(newForm);
    // Here you can do whatever you want with the form data

    try {
      axios
        .post("http://localhost:5000/appointment/add", newForm)
        .then((res) => {
          console.log(res);
        });
    } catch (err) {
  ...
  return (
    <div
      ...
      className={`modal ${
        open ? "block" : "hidden"
      } fixed z-50 inset-0 overflow-auto bg-gray-700 bg-opacity-50`}
    >
      <div
        onClick={(e) => {
          e.stopPropagation();
        ...
        <div className=" flex flex-col justify-start items-start gap-5 w-[100%] box-border">
          <div className=" flex flex-col justify-start items-start  gap-[18px] w-[100%] box-border">
            <div className="flex w-[100%] justify-between">
              ...
              >
                <path
                  d="M33.75 13.75H16.25C14.8693 13.75 13.75 14.8693 13.75 16.25V33.75C13.75 35.1307 14.8693 36.25 16.25 36.25H33.75C35.1307 36.25 36.25 35.1307 36.25 33.75V16.25C36.25 14.8693 35.1307 13.75 33.75 13.75Z"
                  stroke="#298EA6"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M28.75 21.25L21.25 28.75"
                  stroke="#298EA6"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M21.25 21.25L28.75 28.75"
                  stroke="#298EA6"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
          ...
          <form>
            <div className=" flex flex-col justify-start items-start gap-3 w-[undefinedundefined] box-border">
              ...
              <input
                ...
                className="border-[#4c606e7f] text-primary1 flex flex-row justify-center items-center gap-2.5 w-[100%] pl-[9px] pr-[261px] py-[13px] border-[0.5px]  border-solid rounded-lg box-border text-xs leading-3  font-urbanist  font-[500]"
              />
            </div>
            <div className=" flex flex-col justify-start items-start gap-3 w-[undefinedundefined] box-border">
              <p className="   text-primary1 border-[#063248ff] text-base leading-4  font-urbanist  font-[600]">
              ...
              <input
                ...
                className="text-primary1  border-[#4c606e7f] text-xs leading-3  font-urbanist  font-[500] justify-center items-center  w-[100%] pl-[9px]  pt-[13px] pb-[69px] border-[0.5px] pr-[261px] border-solid rounded-lg box-border"
              />
            </div>
            <div className=" flex flex-col justify-start items-start gap-3 w-[undefinedundefined] box-border">
                ...
                <div className=" flex flex-col justify-start items-start gap-3 h-[100%] box-border">
                  ...
                  8 july, 2023
                    ...
                    <input
                      ...
                      placeholder="HH:MM"
                      className="text-primary1 text-base leading-4  font-urbanist  font-[500]"
                    />
                  </div>
                </div>
                <div className=" flex flex-col justify-start items-start gap-3 h-[100%] box-border">
            ...
            <div className="   border-[#298ea6ff]  text-[15px]  text-[#298ea6ff] leading-[15px]  font-urbanist  font-[600] flex flex-row justify-start items-start gap-3 w-[undefinedundefined] box-border">
              <button
                onClick={onClose}
                className=" flex flex-row justify-center items-center gap-2.5 h-[100%] px-[66px] py-[13px] border-[0.5px]  border-[#298ea6ff] border-solid rounded-lg box-border"
              >
                Cancel
              </button>
              <button
