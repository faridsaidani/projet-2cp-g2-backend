...
const SideBarAdmin = ({ currentPage }) => {
  ...
  return (
    <div className="flex flex-col justify-between items-center h-[650px] rounded-xl bg-primdark m-10">
      <div>
            ...
            <div
              className={` p-4 flex justify-start items-center cursor-pointer ${
                currentPage === "overview"
                  ? "rounded-md bg-seclight text-primdark"
                  : ""
              }`}
            >
