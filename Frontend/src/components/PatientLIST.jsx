    ...
    return (
      ...
      >
        ...
        <li className="items-center">
          <Link
            to="/therapist/chat"
            className="text-[#298EA6] items-center gap-2 justify-center text-[12px] flex font-[700] leading-[14.4px] font-urbanist   w-[95px] rounded-lg h-[33px] bg-[#E3F1F4]"
          >
            <svg
              width="20"
              height="21"
            ...
            >
              <path
                d="M2.5 17.9999L4.08333 13.2499C3.33094 11.7455 3.13843 10.0225 3.54025 8.38923C3.94208 6.75592 4.912 5.3189 6.27646 4.33533C7.64093 3.35176 9.31087 2.88584 10.9874 3.02094C12.664 3.15605 14.2378 3.88336 15.4272 5.07272C16.6165 6.26208 17.3438 7.83587 17.4789 9.51244C17.614 11.189 17.1481 12.859 16.1646 14.2234C15.181 15.5879 13.744 16.5578 12.1107 16.9596C10.4773 17.3615 8.75435 17.1689 7.25 16.4166L2.5 17.9999Z"
                stroke="#298EA6"
