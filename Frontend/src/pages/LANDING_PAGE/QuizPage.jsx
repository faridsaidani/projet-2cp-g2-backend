            ...
            <div className='flex flex-col h-[100%] w-[100%]'>
                <div className='flex h-[90%] '>
                        ...
                        <div className='flex flex-col w-[10%] '>
                            ...
                            <div className='mb-auto  mr-auto  w-[70%]'>
                                <img src={petals} alt="" />
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col w-[10%]'>
                            <div className='mb-auto mt-[50%] ml-auto w-[70%] '>
                                <img src={petals} alt="" />
                            </div>
                            <div className=' mb-auto mt-[80%] ml-auto  w-[80%]'>
                                <img src={design} alt="" />
                            </div>
                ...
                <div className='w-[5%] h-[10%] mr-auto ml-[40%] mt-2'>
