...
const Team = () => {
  return (
    <div className='grid grid-cols-[20%_80%] h-screen overflow-hidden'>
        <SideBarAdmin currentPage='team'></SideBarAdmin>
        <div className='flex flex-col h-screen'>
            ...
            <div className='flex justify-between w-[100%] mb-4 '>
              ...
              <Link to='/admin-dashboard/add-team'>
                <button className="px-2 py-2 gap-10 border rounded-md bg-sechover font-urbanist text-sm text-secwhite font-semibold text-center">
                  Add New Member
                </button>
              </Link>  
            </div>
