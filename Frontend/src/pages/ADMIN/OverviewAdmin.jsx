...
const OverviewAdmin = () => {
  ...
  return (
    <div className="grid grid-cols-[20%_80%] h-screen overflow-hidden">
        <SideBarAdmin currentPage='overview'/>
        <div className='flex flex-col h-screen'>
                <TopBar/>
                <div className="flex flex-col justify-between items-center text-urbanist my-10 mr-10 border">
                        ...
                        <div className="flex flex-col flex-1 justify-center items-center w-[100%] h-[100%] mt-10 ">
                            <div className="flex flex-col justify-between w-[100%] h-[95%] shadow-xl  rounded-xl p-4">
                              ...
                              {/*Area Chart*/}
                              <div className="flex justify-center items-center flex-1 border border-red-600">
