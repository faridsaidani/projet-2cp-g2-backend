...
const BlogAdmin = () => {
  ...
  return (
    <div>
        ...
        <TopBar></TopBar>
        <div className="flex flex-col items-center fixed  w-[74%] h-[75%] text-urbanist mb-10 mr-10 right-0 bottom-0 border">
            <div className='flex justify-between w-[100%] mb-6 border'>
                <span className="text-2xl text-primdark font-semibold leading-38.4 tracking-tighter text-left w-83 h-38 gap-0">Dashboard</span>
            </div>
