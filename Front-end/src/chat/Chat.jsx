...
const Chat = () => {
  return (
    <div className=" w-[80%]">
      ...
      <div className="flex w-[100%] justify-between   dark:bg-[gray-900]">
        <div className="w-[31%] h-screen dark:bg-gray-800 rounded-[18px]  bg-[#E3F1F4] px-[18px] py-[21px]  hidden md:block">
          <div className="h-full overflow-y-auto">
            <div className=" text-[#063248] dark:text-gray-200 mb-[32px] font-[600]  leading-[38.4px] text-[32px] font-urbanist ">
              Messages
            </div>
